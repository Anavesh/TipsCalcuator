...
// This extensions to MainViewController defines the logic of CalculationButton. The logic of the button is coded as extension to MainViewController due to the fact that the calculation data will be obtained from different views (TotalBillView, PersonsView and TipsView)
